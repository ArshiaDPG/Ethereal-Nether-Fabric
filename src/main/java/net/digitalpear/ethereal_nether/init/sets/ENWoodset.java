...
public record ENWoodset(String name, MapColor topColor) {
    ...
    public static Block createSoilNylium(ENWoodset woodset){
    ...
    public static Block createPlanks(ENWoodset woodset){
    ...
    public static Block createStairs(ENWoodset woodset, Block baseBlock){
    ...
    public static Block createSlab(ENWoodset woodset){
    ...
    public static Block createHypahe(ENWoodset woodset, boolean stripped){
    ...
    public static Block createStem(ENWoodset woodset, boolean stripped){
    ...
    public static Block createButton(ENWoodset woodset){
    ...
    public static Block createPressurePlate(ENWoodset woodset){
    ...
    public static Block createRoots(ENWoodset woodset){
    ...
    public static Block createPottedRoots(ENWoodset woodset, Block baseBlock){
    ...
    public static Block createSprouts(ENWoodset woodset){
    ...
    public static Block createDoor(ENWoodset woodset){
