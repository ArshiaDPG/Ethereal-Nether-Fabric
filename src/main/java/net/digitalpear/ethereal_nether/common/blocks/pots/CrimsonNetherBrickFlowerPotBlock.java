package net.digitalpear.ethereal_nether.common.blocks.pots;
...
public class CrimsonNetherBrickFlowerPotBlock extends Block {
    ...
    public CrimsonNetherBrickFlowerPotBlock(Block content, Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (bl != bl2) {
            if (bl2) {
                ...
                world.setBlockState(pos, ENBlocks.CRIMSON_NETHER_BRICK_FLOWER_POT.getDefaultState(), 3);
            }
