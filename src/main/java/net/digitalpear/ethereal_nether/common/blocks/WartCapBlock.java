...
public class WartCapBlock  extends Block {
    ...
    public static TagKey<Block> INSIDER_BLOCKS;

    public WartCapBlock(TagKey<Block> compatibleBLocks, Settings settings) {
        super(settings);
        this.INSIDER_BLOCKS = compatibleBLocks;
