...
public class NetherBrickFlowerPotBlock extends Block {
    ...
    public NetherBrickFlowerPotBlock(Block content, Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (bl != bl2) {
            if (bl2) {
                ...
                world.setBlockState(pos, ENBlocks.NETHER_BRICK_FLOWER_POT.getDefaultState(), 3);
            }
